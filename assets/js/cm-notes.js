...
(function ($) {
    ...
    // FUNCIÓN FALTANTE CORREGIDA - bindMarkerSelectionEvents
    ...
    // FUNCIÓN FALTANTE CORREGIDA - startNotesSelectionMode
    window.ConsoleMonitor.startNotesSelectionMode = function () {
        console.log('📍 Starting notes selection mode');
        ...
        console.log('📍 Notes selection mode activated');
    };
